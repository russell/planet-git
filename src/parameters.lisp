...
(defun make-let-parameter (description default-parameter-type default-request-type)
  ...
  (destructuring-bind (parameter-name &key (real-name (string-downcase parameter-name))
                                           parameter-type init-form request-type)
      description
    `(,parameter-name (or (hunchentoot::compute-parameter ,real-name
...
(defmacro with-request-args (lambda-list &body body)
  "Binds the request args to the local scope, it will default to GET
parameters."
